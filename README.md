...
A sample report:
<div align="center">
    <img src="https://github.com/kuanghl/benchmark_json_analysis/blob/master/charts.png">
</div>
...
```
git clone https://github.com/kuanghl/benchmark_json_analysis.git
...
python3 ../benchmark_monitor.py -d . -w 6 -a 0.01 -sc
```
